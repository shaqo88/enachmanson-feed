# Podcast Directory Inventory

Public discovery is captured automatically where an open directory API exists.
Private dashboard ownership and recovery details must be filled in manually.
